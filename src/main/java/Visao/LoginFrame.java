...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame(GrpcClient client) {
        this.ImageCSS();
        ...
        entrarButton.addActionListener(e -> {
            if (camposPreenchidos()) {
                ...
                client.RealizaLogin(username, password);
                if (client.getTimeModel() != null) {
                    AppFrame app = new AppFrame(client.getTimeModel().getIdTime(), client);
                    dispose();
                    client.setTimeModel(null);
                } else {
